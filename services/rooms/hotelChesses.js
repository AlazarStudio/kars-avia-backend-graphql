    ...
    if (hotelChess.id) {
      ...
      if (hotelChess.requestId) {
        ...
        await logAction({
          ...
          fulldescription: `Заявка № ${updatedRequest.requestNumber} была перенесена в номер ${hotelChess.room} пользователем ${user.name}`,
        ...
        await logAction({
          ...
          fulldescription: `Бронь № ${hotelChess.reserveId} была перенесена в номер ${hotelChess.room} пользователем ${user.name}`,
          oldData: previousHotelChessData,
          newData: hotelChess,
          hotelId: hotelChess.hotelId,
          reserveId: hotelChess.reserveId
      ...
      if (hotelChess.requestId) {
        ...
        await logAction({
          ...
          fulldescription: `${updatedRequest.person.name} был размещен в отеле ${hotelInfo?.name} в номер ${hotelChess.room} по заявке № ${updatedRequest.requestNumber} пользователем ${user.name}`,
          oldData: null,
    ...
    if (hotelChess.id) {
      ...
      if (hotelChess.requestId) {
        ...
        await logAction({
          ...
          action: "update_hotel_chess",
          description: `Заявка перенесена в номер ${hotelChess.room}`,
          fulldescription: `Заявка № ${updatedRequest.requestNumber} перенесена в номер ${hotelChess.room} пользователем ${user.name}`,
          oldData: previousHotelChessData,
          newData: hotelChess,
          hotelId: hotelChess.hotelId,
          requestId: updatedRequest.id
        ...
        await logAction({
          ...
          action: "update_hotel_chess",
          description: `Бронь перенесена в номер ${hotelChess.room}`,
          fulldescription: `Бронь № ${hotelChess.reserveId} перенесена в номер ${hotelChess.room} пользователем ${user.name}`,
          oldData: previousHotelChessData,
          newData: hotelChess,
          hotelId: hotelChess.hotelId,
          reserveId: hotelChess.reserveId
      ...
      if (hotelChess.requestId) {
        ...
        await logAction({
          ...
          action: "update_hotel_chess",
          description: `Размещение создано в номере ${hotelChess.room}`,
          fulldescription: `${updatedRequest.person.name} был размещен в отеле ${hotel?.name || ""} в номер ${hotelChess.room} по заявке № ${updatedRequest.requestNumber} пользователем ${user.name}`,
          oldData: null,
          newData: newHotelChess,
          hotelId: hotelChess.hotelId,
          requestId: hotelChess.requestId,
    ...
    if (hotelChess.id) {
      ...
      if (hotelChess.requestId) {
        ...
        await logAction({
          ...
          fulldescription: `Бронь № ${hotelChess.reserveId} была обновлена пользователем ${user.name}`,
          oldData: previousHotelChessData,
          newData: hotelChess,
          hotelId: hotelChess.hotelId
        })
      ...
      if (hotelChess.requestId) {
        ...
        await logAction({
          ...
          fulldescription: `Бронь № ${hotelChess.reserveId} была создана пользователем ${user.name}`,
          oldData: null,
          newData: newHotelChess,
          hotelId: hotelChess.hotelId
        })
