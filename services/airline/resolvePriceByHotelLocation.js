...
export const getCategoryPriceFromContract = (contract, category) => {
  ...
  const priceMap = {
    ...
    economySingle: contract.prices.priceEconomySingle,
    standardSingle: contract.prices.priceStandardSingle,
    standardDouble: contract.prices.priceStandardDouble,
    deluxe: contract.prices.priceDeluxe,
