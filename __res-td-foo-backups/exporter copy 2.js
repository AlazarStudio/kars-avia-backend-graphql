...
export const generateExcelAvia = async (reportData, filePath, companyData, filterInput) => {
...
export const generateExcelHotel = async (reportData, filePath, companyData, filterInput) => {
