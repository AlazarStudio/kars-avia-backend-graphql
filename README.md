...
- **Общие изменения**:
  ...
  - Цены на питание для АК добавлены в основные схемы
  - Обновление чатов поддержки
  - Схема чата для поддержки была "отделена" от основных чатов
  - Изменение сортировки в отчётах (файл отчёта)
  - Исправление подсчёта питания для отчётов
  - Исправление ошибок в чатах поддержи

- **schema.prisma**:

  - Цены на питание для АК
  - Доступ отделов
